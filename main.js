...
d3.csv("weather.csv").then(data => {
    ...
    */
    const pivotedData = groupedData2.flatMap(({ month, avgActualPrecip, avgAvgPrecip, 
        avgRecordPrecip }) => [
        { month, precipitation : avgActualPrecip, measurement: "Actual" },
        { month, precipitation : avgAvgPrecip, measurement: "Average" },
        { month, precipitation: avgRecordPrecip, measurement: "Record" }
    ]);
